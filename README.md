...
### 🧱 Sobre a Estrutura
Essa organização segue arquiteturas amplamente utilizadas no ecossistema Spring:

- **Controller**: recebe requisições HTTP e retorna respostas.  
- **Service**: contém a lógica principal, mantendo o código mais limpo e reutilizável.  
- **Repository**: abstrai consultas SQL usando Spring Data JPA.  
- **Model**: mapeia classes Java para tabelas do banco.  
- **DTO**: melhora segurança e clareza ao transferir dados entre cliente e servidor.  
- **Enums**: agrupam valores constantes do domínio (por exemplo, status de matrícula, tipo de usuário, etc.), deixando o código mais seguro e legível.
